    ...
    return (
        <>
            ...
            <form className="my-4 w-full">
                <textarea className="min-w-[304px] w-full min-h-[112px] text-sm placeholder-zinc-480 
                text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:border-brand-500 
                focus:ring-brand-500 focus:ring-1 resize-none focus:outline-none scrollbar 
                ...
                <footer className="flex gap-2 mt-2">
                    ...
                    <button
                        ...
                        focus:ring-2 focus:ring-offset-zinc-900 focus:ring-brand-500">
